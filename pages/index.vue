<template>
  <div class="flex items-center text-center justify-center h-screen">
    <div class="grid grid-cols-1 gap-4">
      ...
      <div class="flex items-center text-center align-center grid grid-cols-2 gap-4 footer mt-6">
        <a href="/projects" class="animate__animated animate__backInUp">Projects</a>
        <a href="/brandings" class="animate__animated animate__backInUp">Brandings</a>
      </div>
      <p class="footer mt-5 animate__animated animate__backInUp" style="font-family: whitney;">Inspired from <a href="https://premid.app/" target="_blank">PreMid</a>.</p>
    </div>
  </div>
</template>
